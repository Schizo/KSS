...
import com.google.android.exoplayer.demo.ServerAnnotation.Annotation;
import com.google.android.exoplayer.demo.fingerPaint.drawing;
import com.google.android.exoplayer.demo.player.DashRendererBuilder;
import com.google.android.exoplayer.demo.player.DemoPlayer;
import com.google.android.exoplayer.demo.player.DemoPlayer.RendererBuilder;
import com.google.android.exoplayer.demo.player.ExtractorRendererBuilder;
import com.google.android.exoplayer.demo.player.FrameListener;
...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //contentUri = Uri.parse("http://192.168.1.3/kss/output.mp4");
        ...
        mediaController = new VideoControllerView(this, true);

        mediaController.setAnchorView(((FrameLayout) findViewById(R.id.root)));
        ...
        annotation  = new Annotation(getApplicationContext(), this);
       ...
       // public Cue(CharSequence text, int line, int position, Alignment alignment, int size) {
        ...
        //List<WebvttCue> yafes = new ArrayList<WebvttCue>();
        //yafes.add(new WebvttCue("lan olim", -1, 1, Layout.Alignment.ALIGN_CENTER, 2));
        // onCues(yafes);
    ...
    private RendererBuilder getRendererBuilder() {
        String userAgent = Util.getUserAgent(this, "Video on Demand");
        switch (contentType) {
            case TYPE_SS:
    ...
    private void preparePlayer() {
        if (player == null) {
            ...
            timer = new Timer();
            timer.schedule(new FrameListener(player), 0, 40);
        }
    ...
    public void onCues(List<Cue> cues) {
        ...
        Log.d("subtitlelistener", "listener");
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(1, 1, 0, "Seek to Annotation").setShortcut('6', 's');
  ...
  /*        releasePlayer();
    ...
    public void makeAnnotation(View v){
        ...
        intent.putExtra("filename", video_name + "_" + video_id + "_" + String.valueOf( currentTime)  );
        Log.d("valueof", String.valueOf(currentTime));
        intent.putExtra("video_currentTimeMS", String.valueOf(currentTime) );
